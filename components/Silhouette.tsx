...
const PATHS = {
  ...
  run: "M50,15c5.5,0,10-4.5,10-10S55.5-5,50-5s-10,4.5-10,10S44.5,15,50,15z M65,22c-5-2-15-4-15-4s-10,2-15,4 c-4.4,1.8-7,6.3-7,11v35c0,5.5,4.5,10,10,10s10-4.5,10-10V38h4v30c0,5.5,4.5,10,10,10s10-4.5,10-10V33C72,28.3,69.4,23.8,65,22z M44,78h12l3,75 c0.2,4.4-3.3,8.2-7.7,8.3s-8.2-3.3-8.3-7.7L44,78z",
  stand: "M50,15c5.5,0,10-4.5,10-10S55.5-5,50-5s-10,4.5-10,10S44.5,15,50,15z M68,20c-8-2-18-2-18-2s-10,0-18,2 c-4,1-7,4.6-7,8.8v41.2c0,4.4,3.6,8,8,8s8-3.6,8-8v-30h14v30c0,4.4,3.6,8,8,8s8-3.6,8-8V28.8C75,24.6,72,21,68,20z M42,78h16l2,72 c0.1,4.4-3.4,8.1-7.8,8.2c-4.4,0.1-8.1-3.4-8.2-7.8L42,78z",
  sit: "M55,15c5.5,0,10-4.5,10-10S60.5-5,55-5s-10,4.5-10,10S49.5,15,55,15z M60,25c-5-2-10-3-15-3s-10,1-15,3 c-4.4,1.8-7,6.3-7,11v35c0,5.5,4.5,10,10,10s10-4.5,10-10V38h2v30c0,5.5,4.5,10,10,10s10-4.5,10-10V36C67,31.3,64.4,26.8,60,25z M48,78h8l1,78 c0.1,4.4-3.5,8-7.9,8.1c-4.4,0.1-8.0-3.5-8.1-7.9L48,78z"
};
...
const Silhouette: React.FC<SilhouetteProps> = ({ figure, blurAmount }) => {
  ...
  const animate = (time: number) => {
    ...
    if ((figure.activity === 'walk' || figure.activity === 'run') && figure.direction) {
      setCurrentX(prev => {
    ...
    const swayFreq = figure.activity === 'run' ? 0.002 : 0.001;
    const swayAmp = figure.activity === 'run' ? 0.8 : 0.4;
    setSway(Math.sin(elapsed * swayFreq) * swayAmp);
